...
p
ggsave("preference_distribution.png", plot = p, width = 10, height = 3, dpi = 1200, bg = "white")
```
...
p <- ggplot(data = equivtesting_ci, aes(x = mean_diffCQS, y = n)) +
  xlim(equivregion[1]-1,equivregion[2]+1) +
...
```{r Intraclass Correlation Coefficient - MQM}
library(psych)
library(lme4)
